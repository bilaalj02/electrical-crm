...
export const CATEGORIES = [
  ...
  { id: 'protection',       label: 'Circuit Protection',       icon: '🛡️' },
  { id: 'panels',           label: 'Panels & Distribution',    icon: '📋' },
  { id: 'transformers',     label: 'Transformers',             icon: '🔄' },
  { id: 'motors-drives',    label: 'Motors & Drives',          icon: '⚙️' },
  { id: 'control',          label: 'Control Devices',          icon: '🎛️' },
