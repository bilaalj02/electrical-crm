    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content large" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          {/* Actual Expenses Section — admin/manager only */}
          {isManager && (
                ...
                <tbody>
                  {job.costs.materials.map((material, index) => (
                    <tr key={index}>
                      ...
                      {isManager && <td>{formatCurrency(material.unitPrice)}</td>}
                      {isManager && <td>{formatCurrency(material.totalPrice)}</td>}
                    </tr>
                  ))}
                </tbody>
              </table>
